...
with header:
    ...
    st.markdown("Prizepicks has countless sports picks playing at a given time. Lots of the plays on Prizepicks are being offered on other sportsbooks, and we can use that to our advantage.\
        Every play on Prizepicks is **assumed to be 50/50**, but that's impossible for every line. You can go to a sportsbook (Draftkings in this case) and compare the odds. And that's basically the purpose of this tool.")
